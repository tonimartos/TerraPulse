...
const ToolsControl = () => {
  ...
  const handleExportLayers = () => {
    console.log('Exporting layers not implemented yet.');
  };
  ...
  const handleRunAnalysis = () => {
    ...
    // Convert isochrone layers to the format expected by runAnalysis
    const isoParams = isochroneLayers.map(l => ({
      id: l.id,
      geojson: l.geojson,
      time: l.travelTime
    }));
    
    runAnalysis(h3Data, isoParams);
  };
